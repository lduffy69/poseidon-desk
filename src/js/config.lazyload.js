        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                ...
                },
                {
                    ...
                    files: [
                        'vendor/modules/angular-bootstrap-lightbox/angular-bootstrap-lightbox.css',
                        'vendor/modules/angular-bootstrap-lightbox/angular-bootstrap-lightbox.js'
                    ]
                },
                {
                    name: 'ng-file-model',
                    files: [
                        'vendor/modules/ng-file-model/ng-file-model.js'
                    ]
                }
            ]
        });
